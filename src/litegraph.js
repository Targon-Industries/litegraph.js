...
(function(global) {
    ...
    const LiteGraph = (global.LiteGraph = {
        ...
        registerNodeType: function (type, base_class) {
            ...
            if (prev)
                ...
                if (!base_class.prototype.hasOwnProperty("shape"))
                    base_class.prototype.defineProperty("shape", {
                        set: function (v) {
                            switch (v) {
                                case "default":
                                    delete this._shape;
        ...
        registerNodeAndSlotType: function (type, slot_type, out) {
            ...
            const sCN = base_class.constructor.type;

            if (typeof slot_type == "string") {
                let aTypes = slot_type.split(",");
    ...
    LGraph.prototype.onNodeTrace = function() {
        //TODO
    };
...
*/
				...
				if (node && this.allow_interaction && !skip_action && !this.read_only){
					...
					if (
						...
						if (mClikSlot && mClikSlot_index!==false){
                            ...
                            this.createDefaultNodeForSlot({   	nodeFrom: !mClikSlot_isOut?null:node
	...
	*/
	...
	LGraphCanvas.prototype.drawButton = function( x,y,w,h, text, bgcolor, hovercolor, textcolor )
	{
        ...
        const yFix = y + LiteGraph.NODE_TITLE_HEIGHT + 2;	// fix the height with the title
        let pos = this.mouse;
        const hover = LiteGraph.isInsideRectangle(pos[0], pos[1], x, yFix, w, h);
        pos = this.last_click_position;
        const clicked = pos && LiteGraph.isInsideRectangle(pos[0], pos[1], x, yFix, w, h);
        ...
        for (let i = 0; i < node.widgets.length; ++i) {
			...
			switch (w.type) {
				...
				case "slider":
                    ...
                    const nvalue = Math.clamp((x - 15) / (widget_width - 30), 0, 1);
                ...
                if (group) {
                    ...
                    menu_info.push(null, {
                        ...
                        submenu: {
                            title: "Group",
                            extra: group,
                            options: this.getGroupMenuOptions()
                        }
                    });
                }
            }
	...
	CurveEditor.prototype.onMouseUp = function( )
	{
		this.selected = -1;
		return false;
	}
